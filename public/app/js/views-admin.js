      ...
      mount(root) {
        ...
        const paint = () => {
          ...
          root.querySelector('#lstats').innerHTML =
            '<div class="card stat flat"><h2>' + (vv == null ? '—' : CN.fmtVal(vv, variable)) + '</h2><p>Última lectura de ' + CN.varLabel(e.type, variable).toLowerCase() + '</p></div>' +
            ...
            '<div class="card stat flat"><h2>' + (lr ? (ago < 120 ? 'Hace ' + ago + ' s' : CN.timeAgo(lastTick)) : '—') + '</h2><p>Última actualización</p></div>';
